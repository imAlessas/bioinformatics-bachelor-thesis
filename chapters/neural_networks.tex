...
In genere, ogni livello convoluzionale è seguito da un \acs{ReLU} layer. Questo livello sostituisce la funzione di attivazione sigmoidale con una funzione detta rettificatrice, definita come segue:
% 
\begin{gather*}
