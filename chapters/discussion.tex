...
\begin{figure}[!b]
    ...
    \caption[Confronto delle prestazioni predittive dei tre tool su diverse specie animali.]{Confronto delle prestazioni predittive dei tre tool su diverse specie animali attraverso le cruve \acs{ROC}, mostrate per ogni \acs{OCR}, e dai valori medi di \acs{AUROC}\,\cite{ma2023deepsata}.}\label{fig:comparison}
\end{figure}
% 
