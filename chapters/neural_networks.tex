...
Al modello di neurone artificiale del percettrone si aggiunge anche l'\textit{Adaline} (\textit{Adaptive Linear Neuron}) la cui learning rule 
% 
\begin{gather*}
    w_i \, = \, w_i \, + \, \eta\,\left( y_j - v_j \right)\, X_j^i
\end{gather*}
...
\begin{figure}[!t]
    ...
    \caption[Grafico della funzione sigmoide $\sigma(v)$.]{Grafico della funzione gradino $\sigma(v)$.}\label{fig:sigmoid-function}
\end{figure}
% 
