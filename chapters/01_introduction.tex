...
Più precisamente, nel capitolo\,\ref{chp:CNN} su discuterà la storia dell'intelligenza artificiale e saranno esplorati i concetti che si trovano alla base delle reti neurali e di come le reti neurali convoluzionali possono essere utilizzate come ottimo strumento per predire l'effetto di sequeze genomiche. Il capitolo\ref{chp:implementation-details} invece discuterà i dettagli implementativi di ciascuno dei tre tool, indagando principalmente negli aspetti legati alla codifica delle sequenze, alla struttura della rete e al \textsl{dataset} utilizzato per allenare il modello.
